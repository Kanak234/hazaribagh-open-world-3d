...
import { EngineTelemetry, LandmarkData, Vector3D } from '../core/Types';
...
export class GameHUD {
  ...
  private speedometerEl: HTMLDivElement;
  private speedNumberEl: HTMLSpanElement;
  private speedUnitEl: HTMLSpanElement;
  private rpmBarEl: HTMLDivElement;
  private stateBadgeEl: HTMLSpanElement;
  private landmarkBadgeEl: HTMLSpanElement;
  ...
  public setNavigationData(roadGraph: RoadGraph, landmarks: LandmarkData[]): void {
   ...
   */
  public update(telemetry: EngineTelemetry, playerHeadingYaw: number): void {
  ...
  private renderMinimap(playerPos: Vector3D, playerHeadingYaw: number): void {
